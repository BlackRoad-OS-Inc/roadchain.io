# ROADMAP — roadchain.io

> Product roadmap for RoadChain
...
- [ ] Deploy index.html to roadchain.io
- [ ] DNS configuration (Gematria or CF)
- [ ] SSL/TLS auto-provisioned
- [ ] RoadCode CI/CD pipeline
- [ ] Mirror to Gitea

**Milestone**: Site live at https://roadchain.io with < 2s load time.

## Phase 2: Product (Week 3-4)

**Goal**: Real product pages with Stripe integration.

- [ ] Product landing pages for: RoadChain Ledger, Smart Contracts, Stablecoin Bridge, DID
...
**Milestone**: First paying customer through roadchain.io.
...
**Milestone**: roadchain.io is a thriving part of the BlackRoad ecosystem.

---

*BlackRoad OS, Inc. — Pave Tomorrow.*
*Category: blockchain | Products: RoadChain Ledger, Smart Contracts, Stablecoin Bridge, DID*
